title:: Query function type:: [[Feature]] platforms:: [[All Platforms]] description:: This runs custom transformations
on a query's results, usually to calculate aggregations initial-version:: 0.2.6
